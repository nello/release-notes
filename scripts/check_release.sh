...
BUILD_COMMAND="export BUNDLER_VERSION=${BUNDLER_VERSION}; gem install bundler -v \${BUNDLER_VERSION} && bundle install && bundle exec ./bin/notes --check-unfinished ${1} && echo '' && bundle exec ./bin/notes ${1}"
